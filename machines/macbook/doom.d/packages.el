...
;; TODO: enable after the new tree-sitter grammars are in Nix, like next release
;;(package! scala-ts-mode :recipe (:host github :repo "KaranAhlawat/scala-ts-mode"))
(package! copilot
